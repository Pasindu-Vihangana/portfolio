  ...
  return (
    <div className="flex-1 flex flex-col font-sans">
      ...
      <section className="min-h-dvh flex items-center relative overflow-hidden select-none backdrop-blur-[2px]">
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat blur-xs opacity-5" style={{ backgroundImage: `url('${process.env.NEXT_PUBLIC_BASE_PATH || ""}/assets/hero_mechatronics.jpeg')` }} />
